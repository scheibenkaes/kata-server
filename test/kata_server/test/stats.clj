...
(def test-data 
  {:roster {:foo [[1 2 3][6][4 5]] :bar [[3 2 1]]} :current-play [5 5 5] :active-player :bar})

(def test-game
  [test-data test-data])

(deftest test-add-final-roster
  (is (= {:foo [[1 2 3][6][4 5]] :bar [[3 2 1] [5 5 5]]}
...
(deftest test-add-throw-distri
  (let [d (add-final-roster test-data)]
    (is (= {:foo {1 1 2 1 3 1 4 1 5 1 6 1} :bar {1 1 2 1 3 1 4 0 5 3 6 0}}
